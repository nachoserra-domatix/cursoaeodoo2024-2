...
class TestVeterinaryAppointment(common.TransactionCase):
    ...
    def setUp(self):
        super().setUp()
        self.partner = self.env['res.partner'].create({'name': 'Jose', 'email': 'jose@hotmail.com','phone':'678132134'})
    ...
    def test_create_tags(self):
        ...
        self.assertIn(self.appointment.reason, self.appointment.tag_ids.mapped('name'))
